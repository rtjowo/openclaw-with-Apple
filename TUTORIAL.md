...
### （可选）Apple ID 邮箱 + 主密码 — 用于照片/Drive/设备/Health

如果你还想用照片浏览、文件管理、设备查找、健康分析功能，把你的 Apple ID 邮箱和密码也告诉 AI。
...
| "看看我今天的日历" | 显示今日所有事件 |
| "这周有什么安排" | 显示本周日历事件 |
| "帮我建个日程，周六下午3点到4点打羽毛球" | 创建日历事件 |
| "删掉周六打羽毛球那个日程" | 搜索并删除对应事件 |

> 💡 只有你明确说了**具体时间点**（"2点"、"15:00"），AI 才会写日历。说"明天去洗车"这种没有具体时间的，只会写提醒事项，不会往日历里塞。
...
| 功能 | 链接 |
|------|------|
| Health Daily Export（健康数据采集） | https://www.icloud.com/shortcuts/4a5dff0072a6463a9a1fef47d6ec13e2 |
| Tasks Import（提醒事项导入） | https://www.icloud.com/shortcuts/9054c0236adb4909b3dbf72fa58b4933 |
| Notes Import（备忘录导入） | https://www.icloud.com/shortcuts/56d84868591f4233b7d362c83fb71d59 |
